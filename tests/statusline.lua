-- copied from https://github.com/nvim-lualine/lualine.nvim/blob/0a5a66803c7407767b799067986b4dc3036e1983/tests/statusline.lua
    ...
    if not hl_map[hl_name] then
      ...
      table.insert(
        ...
        string.format(
          ...
          hl_id,
          hl_name,
          vim.inspect(hl_map[hl_name], { newline = ' ', indent = '' })
        )
      )
  ...
  for i = 1, #hl_list do
    ...
    if start ~= finish then
      table.insert(
        ...
        string.format(
          '{%d:%s}',
          hl_map[hl_list[i].group].id,
          vim.fn.strpart(stl_buf, start, finish - start)
        )
      )
    end
  end
